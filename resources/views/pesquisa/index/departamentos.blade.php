@foreach ($data as $key=>$item)
    ...
    <td class="text-center">
        @if($item['ic_com_bolsa'] > 0)
            <a href="/pesquisa/iniciacao_cientifica?departamento={{$key}}&bolsa=true">
            {{$item['ic_com_bolsa']}}
            </a>
        @else
            0
    ...
    <td class="text-center">
        ...
        <a href="/pesquisa/iniciacao_cientifica?departamento={{$key}}&bolsa=false">
            {{$item['ic_sem_bolsa']}}
        </a>
        @else
        0
    ...
    <td class="text-center">
        ...
        <a href="/pesquisa/pos_doutorandos?departamento={{$key}}&bolsa=true">
    ...
    <td class="text-center">
        ...
        <a href="/pesquisa/pos_doutorandos?departamento={{$key}}&bolsa=false">
