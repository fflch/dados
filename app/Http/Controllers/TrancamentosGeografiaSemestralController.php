...
class TrancamentosGeografiaSemestralController extends Controller
{
    private $data;
    private $excel;
    ...
    public function grafico()
    {
        ...
        return view('trancamentosGeografiaPorSemestre', compact('chart'));
    }
    ...
    public function export($format)
    {
        if ($format == 'excel') {
            ...
            return $this->excel->download($export, 'trancamentos_geografia_semestral.xlsx');
        }
    }
}