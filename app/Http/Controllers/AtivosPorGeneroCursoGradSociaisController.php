...
class AtivosPorGeneroCursoGradSociaisController extends Controller
{
    ...
    public function __construct(Excel $excel){
        ...
        /* Contabiliza alunos graduação gênero - sociais */
        $query = file_get_contents(__DIR__ . '/../../../Queries/conta_alunogr_sociais_genero.sql');
    ...
    public function export($format)
    {
        if($format == 'excel') {
            ...
            return $this->excel->download($export, 'ativos_grad_genero_sociais.xlsx'); 
        }
    }
}
