...
class AtivosPorGeneroPosController extends Controller
{
    ...
    public function __construct(Excel $excel)
    {
        ...
        $query = file_get_contents(__DIR__ . '/../../../Queries/conta_alunopos_genero.sql');

        /* Contabiliza alunos da pós por gênero. */
    ...
    public function export($format)
    {
        if ($format == 'excel') {
            ...
            return $this->excel->download($export, 'ativos_por_genero_pos.xlsx');
        }
    }
}