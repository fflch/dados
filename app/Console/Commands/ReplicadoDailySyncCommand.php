...
class ReplicadoDailySyncCommand extends Command
{
    ...
    private function sync_estagiarios(){
        ...
        foreach($estagiarios as $estagiario){
            $pessoa = PessoaModel::where('codpes',$estagiario['codpes'])
                ->where('tipo_vinculo', 'Estagiario')->first();
            if(!$pessoa) $pessoa = new PessoaModel;
    ...
    private function sync_monitores(){
        ...
        foreach($monitores as $monitor){
            ...
            $pessoa = PessoaModel::where('codpes',$monitor['codpes'])
                ->where('tipo_vinculo', 'Monitor')->first();
            if(!$pessoa) $pessoa = new PessoaModel;
